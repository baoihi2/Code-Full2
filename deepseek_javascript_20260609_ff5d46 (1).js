...
// @version      28.0
// @description  Tự động click - Xóa URL con trỏ 13-18
// @author       AutoClicker
...
(function() {
    ...
    // ========== CẤU HÌNH ==========
    const CLICK_DELAY = 1000;  // 1 giây mỗi click cho tất cả trừ con trỏ 1
    const DEFAULT_MAX_CLICKS = 4;
    const TRIGGER_1_MAX_CLICKS = 5;
    ...
    const triggers = [
        { id: 1, name: "Vào Game", url: "btn_login.png", fullUrl: "http://dragonballh5.com/atlas/img/btn_login.png", x: 108, y: 397, needClick: true, maxClicks: TRIGGER_1_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 2, name: "Đặt tên", url: "bg_xuanren.jpg", fullUrl: "http://dragonballh5.com/@New/login/create/bg_xuanren.jpg", x: 195, y: 408, needInput: true, inputType: "name", needClick: true, maxClicks: DEFAULT_MAX_CLICKS, waitAfterInput: 2000, delay: CLICK_DELAY },
        { id: 3, name: "Xác nhận tên", url: "btn_xacnhan.png", fullUrl: "http://dragonballh5.com/@New/login/create/btn_xacnhan.png", x: 187, y: 452, needClick: true, maxClicks: TRIGGER_3_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 4, name: "Xác định rule", url: null, fullUrl: null, x: 174, y: 335, needClick: true, noUrl: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 5, name: "Bỏ qua", url: "New_character1.png", fullUrl: "http://dragonballh5.com/common/New_character1.png", x: 81, y: 54, needClick: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 6, name: "Avatar", url: "head3022.png", fullUrl: "http://dragonballh5.com/icon/head3022.png", x: 55, y: 21, needClick: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 7, name: "Vào Giftcode", url: "hero_camp_101.png", fullUrl: "http://dragonballh5.com/common/hero_camp_101.png", x: 183, y: 478, needClick: true, maxClicks: TRIGGER_7_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 8, name: "Nhập code", url: "person.png", fullUrl: "http://dragonballh5.com/atlas/img/person.png", x: 211, y: 246, needInput: true, inputType: "code", inputValue: "HOTROREBORN", needClick: true, maxClicks: TRIGGER_8_MAX_CLICKS, waitAfterInput: 2000, delay: CLICK_DELAY },
        { id: 9, name: "Xác nhận code", url: null, fullUrl: null, x: 158, y: 300, needClick: true, noUrl: true, maxClicks: TRIGGER_9_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 10, name: "Chuyển Tab", url: null, fullUrl: null, x: 298, y: 20, needClick: true, noUrl: true, maxClicks: TRIGGER_10_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 11, name: "Vào Guild", url: null, fullUrl: null, x: 263, y: 492, needClick: true, noUrl: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 12, name: "Gia nhập Guild", url: "bg_vaoguild.jpg", fullUrl: "http://dragonballh5.com/common/bg_vaoguild.jpg", x: 245, y: 77, needClick: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 13, name: "Vào cống hiến", url: null, fullUrl: null, x: 204, y: 271, needClick: true, noUrl: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 14, name: "Cống hiến", url: null, fullUrl: null, x: 264, y: 372, needClick: true, noUrl: true, maxClicks: DEFAULT_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 15, name: "Thoát cống hiến", url: null, fullUrl: null, x: 263, y: 492, needClick: true, noUrl: true, maxClicks: TRIGGER_15_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 16, name: "Vào Thành Viên", url: null, fullUrl: null, x: 292, y: 173, needClick: true, noUrl: true, maxClicks: TRIGGER_16_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 17, name: "Thoát Guild", url: null, fullUrl: null, x: 266, y: 406, needClick: true, noUrl: true, maxClicks: TRIGGER_17_MAX_CLICKS, delay: CLICK_DELAY },
        { id: 18, name: "Xác nhận thoát Guild", url: null, fullUrl: null, x: 252, y: 300, needClick: true, noUrl: true, maxClicks: TRIGGER_18_MAX_CLICKS, isFinal: true, delay: CLICK_DELAY }
    ];
    ...
    async function processTrigger(trigger) {
        ...
        if (trigger.url) seenUrls.add(trigger.url);
        currentIndex++;
        saveState();
        isProcessing = false;
    ...
    async function init() {
        ...
        console.log(`📌 Tổng số trigger: ${triggers.length}`);
        console.log(`📌 Các con trỏ 13-18 đã xóa URL (click ngay không cần chờ)`);
    }

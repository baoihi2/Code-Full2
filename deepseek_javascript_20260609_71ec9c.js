...
// @version      30.0
// @description  Tự động click - Bỏ kiểm tra URL con trỏ 12-18
// @author       AutoClicker
...
(function() {
    ...
    const triggers = [
        { id: 1, name: "Vào Game", url: "btn_login.png", fullUrl: "http://dragonballh5.com/atlas/img/btn_login.png", x: 108, y: 397, needClick: true, maxClicks: TRIGGER_1_MAX_CLICKS, delay: CLICK_DELAY, needUrl: true },
    ...
    // ========== KIỂM TRA URL CHỈ CHO TRIGGER CẦN URL ==========
    ...
    async function init() {
        ...
        console.log(`📌 Các trigger 12-18: KHÔNG CẦN URL - click ngay khi đến lượt`);
    }

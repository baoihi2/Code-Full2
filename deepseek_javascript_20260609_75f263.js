// ==UserScript==
// @name         Auto Click DragonBall - 1 Tab (Chạy Nền)
// @namespace    http://tampermonkey.net/
// @version      38.0
// @description  Chạy auto click trong 1 tab duy nhất, có bảng điều khiển
// @author       AutoClicker
...
(function() {
    ...
    console.log("%c🚀 KHỞI ĐỘNG AUTO CLICK (1 TAB DUY NHẤT)", "color: #ff9800; font-size: 16px; font-weight: bold");
